...
function Review() {
    return (
        <div>
            <h2 className='font-light-1'>Opinião</h2>
            <svg
                id="Capa_1"
                ...
                xmlSpace="preserve"
                className='shake-animation quote-svg'
            >
                <g>
                <path className='fill-light-2'
            ...
            <p className='font-light-1'>Saboroso e a um preço acessível. Gostei bastante.</p>
            <h6 className='font-light-2'>- Cândido Barbosa</h6>
        </div>
    )
}
